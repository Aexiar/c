...
> * ② **C/S 架构**：客户端通常较为“厚”，因此前后端界限较清晰，业务逻辑和UI呈现在客户端，服务器主要提供数据和必要的业务支持。C/S系统常用三层架构和SOA（面向服务的架构）来提供较高的系统灵活性。
...
>
> * **可维护性**：业务逻辑清晰、架构合理，可以降低维护难度。例如在 B/S 架构中，通过服务端更新业务逻辑，所有客户端立即生效。
> * **性能优化**：通过架构优化（如负载均衡、缓存策略），能提升系统在高并发场景下的响应速度。
...
> * ② 后端的语言、架构等通常变化比较少，后端程序员也往往有更多的方向，内容去进行提高和沉淀。做后端的潜力，往往是比前端大的。
...
* 目前比较热门的嵌入式领域有：
  * 物联网（iot）：
    ...
    * 智慧城市，交管系统、环境监测等
    * ....
  * 汽车领域，车机系统，汽车上的各种电子系统，辅助驾驶，电子刹车系统等等。新能源汽车的电子控制系统
  * 工业自动化、机械自动化等等
